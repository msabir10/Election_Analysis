...
file_to_load = os.path.join("03 -Election Analysis", "Resources", "election_results.csv")
# Add a variable to save the file to a path.
file_to_save = os.path.join("03 -Election Analysis", "Resources", "analysis", "election_analysis.txt")
